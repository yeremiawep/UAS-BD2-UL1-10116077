  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<div>	
			<a type="button" class="btn btn-primary" href="tambah_divisi.php"><i class="fas fa-plus"></i> Tambah Divisi</a>
		</div>
		<br>
		<div>
			<table id="example1" class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
                  ...
                  <tbody role="alert" aria-live="polite" aria-relevant="all">
					...
					<tr class="odd">
                        ...
                        <td class=" ">
							<a type="button" class="btn btn-success btn-sm" href="update_divisi.php?id=<?php echo $row['id_divisi'];?>"><i class="fas fa-edit"></i></a>
							<a type="button" class="btn btn-danger btn-sm" href="delete_divisi.php?id=<?php echo $row['id_divisi'];?>" onClick="return confirm('Menghapus data divisi <?php echo ucfirst($row['divisi']);?> ?');"><i class="fas fa-trash-alt"></i></a>
						</td>
                    </tr>
					<?php
							}
